        ...
        ///
    {
        ...
        public class EclipseObject
        {
            ...
            public EclipseObject(string name, string type, string path)
            {
                ...
                this.FILE_FOLDER = FILE_PATH.TrimEnd((FILE_NAME + "\\").ToCharArray());//trims off the actual file name to reveal the folder
        ...
        public void backupEssentialUserFiles(EclipseObject userIniObject, string destination)
        {
            ...
            foreach (string i in filePathArray)
                ...
                {   
                    ...
                    copyFile(string, userIniObject.FILE_FOLDER, destination + "\\" + userIniObject.INI_JOB_FOLDER);
                }
                catch (IOException)
                {
