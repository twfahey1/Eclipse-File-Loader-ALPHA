...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        {
            iniObject.INI_JOB_PATH = CURRENT_MAINDIRECTORY5 + "\\" + iniObject.INI_JOB_FOLDER;
            ...
            writeINIbackup(CURRENT_MAINDIRECTORY5 + "\\" + iniObject.INI_JOB_FOLDER, iniObject.INI_INFO_ARRAY);
                ...
                foreach (string d in Directory.GetDirectories(path))
                {
                    foreach (string f in Directory.EnumerateFiles(d))
                    {
                        ...
                        else if (f.Contains(".ini"))
                        {
                            ...
                            //FILE_COUNTER += 1;
                            INI_LIST.Add(obj);
                            //ECL_OBJ_MAP.Add(f.Substring(d.Length + 1), obj);
                            Console.WriteLine("File added: " + f.Substring(d.Length + 1));
                        }
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {
            ...
            if (RestoreEclipseFilesToLocalPC(ECL_OBJ_MAP[currentUsersDropdown.Text])) MessageBox.Show("Files Restored");
        }      
