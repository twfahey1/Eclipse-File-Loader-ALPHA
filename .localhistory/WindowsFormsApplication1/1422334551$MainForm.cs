...
namespace WindowsFormsApplication1
{
    ...
    ///
    {
        ...
        public bool RestoreEclipseFilesToLocalPC(EclipseObject iniObject)
        {
            ...
            string copyFolder = Path.GetDirectoryName(Path.Combine(iniObject.FILE_PATH,iniObject.INI_JOB_FOLDER));
            //Destination uses the current mainDir5, parsed previously from Eclipse.ini, and of course user folder name
            string destination = Path.Combine(CURRENT_MAINDIRECTORY5, iniObject.INI_JOB_FOLDER);
